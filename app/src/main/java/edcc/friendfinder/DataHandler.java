...
class DataHandler {
    ...
    public DataHandler() {
        ...
        classes2.add(12);
        classes2.add(21);
        User friend2 = new User("Anthony", "Luong", "Computer Science", "Memes", "Vietnamese", "All day", classes2);
        ...
        classes4.add(4);
        classes4.add(19);
        User friend4 = new User("Susy", "Lincoln", "Business", "Dancing", "Spanish", "All day", classes4);
        ...
        classes7.add(20);
        classes7.add(5);
        User friend7 = new User("Roxas", "Pham", "Accounting", "Guitar", "Vietnamese", "All day", classes7);

        List<Integer> classes8 = new ArrayList<>();
        classes8.add(2);
        classes8.add(3);
        classes8.add(5);
        User friend8 = new User("Vivian", "Nguyen", "Biology", "Swimming", "Vietnamese", "All day", classes8);

        List<Integer> classes9 = new ArrayList<>();
        classes9.add(3);
        classes9.add(15);
        classes9.add(22);
        User friend9 = new User("Henry", "Zokkins", "Music", "Tennis", "English", "All day", classes9);
